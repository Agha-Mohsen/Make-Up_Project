...
namespace BlogManagement.Application
{
    public class ArticleCategoryApplication : IArticleCategoryApplication
    {
        ...
        public OperationResult Create(CreateArticleCategory command)
        {
            ...
            var path = $"مقالات//{slug}";
            var pictureName = _fileUploader.Upload(command.Picture, path);

            var articleCategory = new ArticleCategory(command.Name, pictureName,
                command.PictureAlt, command.PictureTitle, command.Description, command.ShowOrder,
        ...
        public List<ArticleCategoryViewModel> SearchModel(ArticleCategorySearchModel categorySearchModel)
        {
